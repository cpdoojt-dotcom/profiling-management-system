      ...
      <form className="driver-form glass-panel" onSubmit={handleSubmit}>
            ...
            >
              ...
              {driverImage ? (
                <div className="image-preview">
                  <img src={URL.createObjectURL(driverImage)} alt="Driver preview" />
                  <button
                    type="button"
        ...
        <div className="form-grid">
          ...
          <div className="form-group">
            ...
            <input type="text" name="birthplace" className="input-field" value={driver.birthplace} onChange={handleChange} />
          </div>
          <div className="form-group">
